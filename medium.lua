...
function scene:create( event )
    ...
    local Square = Enemy:new( {HP=3, fR=720, fT=15000, --properties of the square object
                          bT=2700} );
    ...
    local Triangle = Enemy:new( {HP=1, bR=360, fT=15000, 
                             bT=300});
    ...
    function drawBoard()
local imagePaths = {}                   
        imagePaths[1] = "dog_images/a.jpg"         
        --sceneGroup:insert(imagePaths[1])
        imagePaths[2] = "dog_images/b.jpg"         
        --sceneGroup:insert(imagePaths[2])
        imagePaths[3] = "dog_images/c.jpg"          --
        --sceneGroup:insert(imagePaths[3])
        imagePaths[4] = "dog_images/d.jpg"         
        --sceneGroup:insert(imagePaths[4])
        imagePaths[5] = "dog_images/e.jpg"          
        --sceneGroup:insert(imagePaths[5])
        imagePaths[6] = "dog_images/f.jpg"          
        --sceneGroup:insert(imagePaths[6])
        imagePaths[7] = "dog_images/g.jpg"
        --sceneGroup:insert(imagePaths[7])
        imagePaths[8] = "dog_images/h.jpg"
    ...
    --[[function goToTouch( event )
        if ( event.phase == "began" ) then
            print ( "x : "..event.x )
            print ( "y : "..event.y )
        end
    end
    Runtime:addEventListener("touch",goToTouch) ]]
    --x = -68 to 102 and 369 to 570
